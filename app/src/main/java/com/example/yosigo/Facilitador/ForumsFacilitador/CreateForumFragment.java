...
public class CreateForumFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_create_forum, container, false);
        ...
        imagen = (ImageView) root.findViewById(R.id.image_create_forum);
        //Obtenemos la referencia a los botones
        btn_picto = (Button) root.findViewById(R.id.btn_up_picto_forum);
        btn_create = (Button) root.findViewById(R.id.btn_create_forum);
                ...
                fb.collection("forums")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                Navigation.findNavController(root).navigate(R.id.action_createForumFragment_to_nav_forums);
                            }
                        })
